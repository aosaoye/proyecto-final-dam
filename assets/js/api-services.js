// Dynamically get the hostname to support access via 127.0.0.1, localhost, or local network IP
export const API_BASE_URL = `http://${window.location.hostname}:5000/api`;
export const BASE_IMAGE_URL = `http://${window.location.hostname}:5000`;
